...
namespace Application.IServices
{
    public interface IProductService
    {
        ...
        Task<ApiResponseDto<List<ProductResponseDto>>> GetManyWithPagingAsync(Guid userId, Guid? departmentId, Guid? positionId, FilterRequestDto request);
        ...
        Task<ProductResponseDto> UpdateStatusAsync(Guid id, UpdateApprovalRequestDto request);
